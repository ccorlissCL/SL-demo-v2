...
import sty from "./PlasmicToggleButton.module.css"; // plasmic-import: sgSVMgTrZZAp/css
    ...
    >
      ...
      <div
        className={classNames(
          ...
          sty.text__jKimN,
          {
            [sty.textposition2__jKimN9VXyJ]: hasVariant(
              $state,
              "position2",
              "position2"
            )
      ...
      <div
        className={classNames(
          ...
          sty.text___8Ibv,
          {
            [sty.textposition2___8Ibv9VXyJ]: hasVariant(
              $state,
              "position2",
              "position2"
            )

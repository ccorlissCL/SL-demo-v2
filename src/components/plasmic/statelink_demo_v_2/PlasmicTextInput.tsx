...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: sCVLYG7Wc7pl/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__z4AzH)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___247YA)}
              role={"img"}
            />
          ),
